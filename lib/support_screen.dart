...
class SupportScreen extends StatelessWidget {
  ...
  final Map<String, Map<String, String>> _tr = const {
    ...
    'hi': {'title': 'सहायता', 'email': 'ईमेल भेजें', 'play': 'Google Play', 'rate': 'ऐप रेट करें', 'share': 'साझा करें', 'thanks': 'आपके समर्थन के लिए धन्यवाद!'},
'bn': {'title': 'সহায়তা', 'email': 'ইমেইল পাঠান', 'play': 'Google Play', 'rate': 'অ্যাপ রেট করুন', 'share': 'শেয়ার করুন', 'thanks': 'আপনার সমর্থনের জন্য ধন্যবাদ!'},
  };
